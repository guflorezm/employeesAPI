...
{
    /// <summary>
    /// Defines an employee of hourly salary type and is used in the factory of these employees,
    /// it is used to transport data from BL to services layer
    /// In this class we can see the principles of encapsulation, polymorphism and heritance
    /// </summary>
    public class HourlySalaryEmployeeBO : EmployeeBO
    {
        private int _id;
        ...
        public HourlySalaryEmployeeBO(EmployeeDTO employee)
        {
            _id = employee.Id;
            _name = employee.Name;
        ...
        public HourlySalaryEmployeeBO( int id, 
                                        string name, 
        ...
        /// we can use a methos but this aprroach is more effective everytime the hourly salary change, it calculates
        /// the annual salary every time
        /// </summary>
        public override decimal AnnualSalary
        {
            get { return (Constants.NUMBER_HOURS * _hourlySalary * Constants.MONTHS); }
        }
    }
}
